...
openai:
      ...
      --openai.recognize-images                        enable image recognition with OpenAI [$OPENAI_RECOGNIZE_IMAGES]
      --openai.image-recognition-model=                OpenAI model for image recognition (default: gpt-4.1-mini) [$OPENAI_IMAGE_RECOGNITION_MODEL]
...
report:
      ...
      --report.auto-ban-threshold=                     auto-ban after N reports (0=disabled, must be >= threshold) (default: 0) [$REPORT_AUTO_BAN_THRESHOLD]
