...
//     return words either as one word (or phrase) per line or as a comma-separated list of words
...
// To call them WithSpamUpdater and WithHamUpdater methods should be used first to provide
